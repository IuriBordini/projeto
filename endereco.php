...
<h2>cadastrar endereços do cliente: <em><?=$dados['nome'];?> </em>, com login:<em> <?=$dados['login'];?></em></h2>
...
<a href="tabela-pessoas.php">  <input type="submit"  value="Ver outros clientes" /></a>
</body>
</html>